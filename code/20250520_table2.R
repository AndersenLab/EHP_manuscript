...
#------------------------------------------------------------------------------#
mammal <- dat %>%
  dplyr::filter(source %in% c("Widmayer et al. 2022", "Shaver et al. 2023", "Boyd et al. 2016", "NIEHS_ICE"))
...
# output the table
rio::export(tab2_df, file = glue::glue("data/processed/{today}_table2.csv"))
