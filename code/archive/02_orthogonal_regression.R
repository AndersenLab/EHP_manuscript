...
#load("data/processed/20250315.pw.orth.reg.df.rda") # no anthelmintics
load("data/processed/20250519.pw.orth.reg.df.rda") # after anthelmintics added
#==============================================================================#
...
#load orth reg data (UPDATE TO MOST RECENT IF NEEDED)
#load("data/processed/20250315.pw.orth.reg.species.df.rda") # without anthelmintics
load("data/processed/20250519.pw.orth.reg.species.df.rda") # with anthelmintics

# Daphnia magna:LC50:2:Mortality has reasonable sample size for toxins
#==============================================================================#
# Part 5: Export all comparisons
#==============================================================================#
rio::export(pw.orth.reg.df, file = "data/processed/pw_orth_reg_df_by_group2.csv")
rio::export(pwol.df, file = "data/processed/pw_orth_reg_df_by_species2.csv")
