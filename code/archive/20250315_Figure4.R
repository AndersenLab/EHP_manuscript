...
dat <- data.table::fread("data/processed/00_data2.csv")
#==============================================================================#
...
df4a <- dat %>%
  dplyr::filter(source %in% c("Widmayer et al. 2022", "Shaver et al. 2023", "Boyd et al. 2016", "EnviroTox DB")) %>%
...
#==============================================================================#
# Widmayer vs Daphnia magna:LC50:2:Mortality 
# The Daphnia magna data are compelling 
#==============================================================================#
daph <- dat %>%
  dplyr::filter(source %in% c("Widmayer et al. 2022", "Shaver et al. 2023", "Boyd et al. 2016") | latin_name == "Daphnia magna") %>%
...
#==============================================================================#
# put them together
fig4 <- cowplot::plot_grid(pcomp + labs(subtitle = ""),
                           or4ap + labs(subtitle = "", x = "Nematode Imager EC10 (mg/L)", y = "Fish LC50 (mg/L)"), 
                           or4bp + labs(subtitle = "", x = "Nematode Imager EC10 (mg/L)", y = "Invertebrate LC50 (mg/L)"),
                           ordaphp + labs(subtitle = "", x = "Nematode Imager EC10 (mg/L)", y = bquote(~italic("Daphnia magna")~"LC50"~"(mg/L)")),
                           labels = c("A", "B", "C", "D"), align = "vh", ncol = 2)
cowplot::ggsave2(fig4, filename = glue::glue("figures/{today}_figure4.png"), width = 7.5, height = 7.5)
