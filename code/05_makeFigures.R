...
or2 <- pwOrthReg(data = df2, group = "latin_name", min.cases = 3, message = T, plot = T)
...
# run the orth regressions across all pairs
or3a <- pwOrthReg(data = df3a, group = "group", min.cases = 3, message = T, plot = T)
...
# run the orth regressions across all pairs
or3b <- pwOrthReg(data = df3b, group = "group", limit.comp = "NEMATODE", min.cases = 3, message = F, plot = T)
...
# run the orth regressions across all pairs
or3c <- pwOrthReg(data = df3c, group = "group", limit.comp = "NEMATODE", min.cases = 3, message = F, plot = T)
